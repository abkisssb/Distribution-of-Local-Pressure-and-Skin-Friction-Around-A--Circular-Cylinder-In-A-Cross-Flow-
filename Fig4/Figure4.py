...
data = pd.read_csv('fig4_shear.csv')
...
data2 = pd.read_csv('fig4_pressure.csv')
...
#_____________________#FIGURE_4 SHEAR________________________________#
...
ax1.set_title("$\phi_1$= 94$^\circ$", loc='right', y=0.38, x=0.55, fontsize='large')

ax1.plot(x_1, y_1, color ='navy', alpha=.75, lw=2, ls='-', marker ='o',
                                  markersize=7, markerfacecolor ='r', 
                                  markeredgecolor ='r', markeredgewidth=2)

#_____________________#FIGURE_4 PRESSURE________________________________#
