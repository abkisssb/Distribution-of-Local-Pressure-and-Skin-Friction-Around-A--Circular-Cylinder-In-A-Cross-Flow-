...
data = pd.read_csv('fig5_shear.csv')
...
data2 = pd.read_csv('fig5_pressure.csv')
...
#_____________________#FIGURE_5 SHEAR________________________________#
...
ax1.set_title('Skin friction', loc='left', y=0.20, x=0.50, fontsize='large')
ax1.set_title("$\phi_1$= 147$^\circ$", loc='center', y=0.38, x=0.78, fontsize='large')
...
#_____________________#FIGURE_5 PRESSURE________________________________#
...
ax2.set_title('Pressure', loc='left', y=0.80, x=0.50, fontsize='large')
